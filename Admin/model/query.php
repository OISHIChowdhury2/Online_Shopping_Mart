<?php
  ...
  {
  	$con=getConnection();
  	$sql = "INSERT INTO seller values ('','{$user['name']}','{$user['phone']}','{$user['email']}','{$user['nid']}','{$user['username']}','{$user['password']}','{$user['gender']}','{$user['dob']}','{$user['pic']}','{$user['type']}' ,'{$user['salary']}')";
