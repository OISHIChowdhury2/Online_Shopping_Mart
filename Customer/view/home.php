...
<table class="table">
  <tr>
    ...
    <li>	<a   href="../view/login.php" >	Profile 
		</a>
</li>
</ul>
</td>
...
while($row = mysqli_fetch_assoc($result)){
		echo "<div class='product_wrapper'>
			  ...
			  <div class='image'><img src='../img/".$row['image']."'height='450px' /></div>
			  <div class='name'>".$row['name']."</div>
		   	  <div class='price'>$".$row['price']."</div>
		   	   <input type='hidden' name='quantity' value=".$row['quantity']." />
			 <form action=../controller/payment.php method='POST'>
			 <button type='submit' class='buy'>Buy Now</button></a>
			 </form>
			  </form>
		   	  </div>";
        }
...
<div class="form-popup" id="myForm">
  ...
  <p id="demo"></p>
 <input id="id1" type="textarea" min="100" max="300">
