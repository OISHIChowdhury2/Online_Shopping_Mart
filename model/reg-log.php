<?php
   ...
   function insertUser($user)
   {
		...
		$conn = getConnection();
     $sql = "INSERT INTO user values ('','{$user['name']}','{$user['username']}','{$user['phone']}','{$user['email']}','{$user['password']}','{$user['address']}','{$user['gender']}','{$user['user']}')";
...
function validateSeller($username, $password){
$conn= getConnection();
